...
async function createWidget() {
  ...
  let startColor = new Color(
    Device.isUsingDarkAppearance() ? "#141414" : "#7b4397"
  );
  let endColor = new Color(
    Device.isUsingDarkAppearance() ? "#13233F" : "#dc2430"
  );
  ...
  let appIconElement = titleStack.addImage(icon);
  appIconElement.imageSize = new Size(15, 15);

  titleStack.addSpacer(4);
  let titleElement = titleStack.addText(`${l.name} Station`);
...
function addText(listwidget, text) {
  ...
  body.font = Font.boldSystemFont(14);
...
function getIcon() {
  const url = "https://www.iconsdb.com/icons/preview/white/train-2-xxl.png";
